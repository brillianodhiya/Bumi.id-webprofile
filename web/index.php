		...
		<div class="container">
			...
			<div class="w3_banner_info">
				<div class="w3_banner_info_grid">
					<h3 class="test">We Are Planting A Tree To Save Our Earth From Global Warming</h3>
					<p>Future Green for Safety Grandchild and Beautiful Scenery</p>
					<ul>
						<li><a href="contact.php" class="w3l_contact">Contact Us</a></li>
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						...
						<p>The environment, is everything that is around humans and reciprocal
						The opposite of the environment is the artificial environment, which includes the region and its components
						which is much influenced by humans.
							<i>"Don't Use Greening For Propaganda"</i></p>
					</div>
				</section>
			</div>
		</div>
			...
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						...
						<p>We Welcome All Requests To All Reforestation Consultants.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
			...
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						...
						<p>We Provide Eco-friendly Product Certification To Your Project.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
		...
		<div class="col-md-4 agileits_banner_bottom_left2">
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						<h4>Free Helpline</h4>
						<p>We will help anything related to greening.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
...
<!-- welcome -->
	<div class="welcome">
		<div class="container">
			...
			<p class="agile_para">We also have our own fruit plantations.</p>
		</div>
...
<!-- news -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Latest <span>News</span> from <span>Bumi.id</span></h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive">
			</div>
			<p class="agile_para">Bumi.id do many things and also provide a lot of information about plantation and greening</p>
      <?php
      $dbh = mysqli_connect("localhost", "root", "", "bumi");
      if($dbh === false){
          die("ERROR: Could not connect. " . mysqli_connect_error());
      }
      $sql = "select * from tbl_artikel order by no DESC limit 3";
      ...
      <div class="w3ls_news_grids">
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="<?php echo $image_src; ?>" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3><?php echo $row[2]; ?></h3></div>
						</div>
					</div>
					<div class="agileits_w3layouts_news_grid">
						<ul>
							<li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo $row[6]; ?></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><a href="#"><?php echo $row[4]; ?></a></li>
						</ul>
						<h4><a href="article.php?no=<?php echo $row[0]; ?>"><?php echo $row[1]; ?></a></h4>
						<p><p style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row[5]; ?></p></p>
          </div>
					</div>
				</div>
        <?php } ?>
...
<!-- newsletter -->
	<div class="newsletter">
		<div class="container">
			...
			<p class="agile_para agileits_para">Subscribe and you will get newsletter.</p>
