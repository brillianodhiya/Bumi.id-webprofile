...
<!-- breadcrumbs -->
	...
	<!-- //breadcrumbs -->
		<div class="welcome">
			<div class="container">
				<h3 class="agileits_w3layouts_head">Latest<span> Article</span> In Table</h3>
				<div class="w3_agile_image">
					<img src="images/1.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3ls_news_grids">
  				<div class="col-md-13 w3_agile_mail_left">
  					<div class="agileits_mail_grid_right1 agile_mail_grid_right1">
							<div class="table-consensed">
  						<table class="table">
								<tr>
									<th>No.</th>
									<th>Title</th>
...
<!--//SQL-->
								...
								<tr>
									...
									<td><img src="<?php echo $image_src;?>" height="75"></td>
									<td><?php echo $row[5]; ?></td>
									<td><?php echo $row[6]; ?></td>
									<td><?php echo $row[4]; ?></td>
									<td><a href="edit.php?no=<?php echo $row[0]; ?>"><button type="button" class="btn">Edit</button></a></td>
									<td><a href="delete.php?no=<?php echo $row[0]; ?>" ><button type="button" class="btn">Delete</button></a></td>
								</tr>
