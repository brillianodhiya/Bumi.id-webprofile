...
<!-- services -->
	<div class="welcome">
		<div class="container">
			...
			<p class="agile_para">This is the service we provide.</p>
			<div class="w3_agile_services_grids">
				<div class="col-md-6 w3_agile_services_grid">
					...
					<div class="col-xs-8 w3_agile_services_grid_right">
						<h4>Fertile soil and easy to plant</h4>
						<p>We provide fertile ground for renewal of land that needs it..</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 w3_agile_services_grid">
					...
					<div class="col-xs-8 w3_agile_services_grid_right">
						<h4>Suppliers of quality seed seeds</h4>
						<p>We provide a variety of plant seeds. although it is both fruits and vegetables.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 w3_agile_services_grid">
					...
					<div class="col-xs-8 w3_agile_services_grid_right">
						<h4>Training how to plant various kinds of plants</h4>
						<p>We can teach you how to grow fruits, vegetables and other plants in the right way.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 w3_agile_services_grid">
					...
					<div class="col-xs-8 w3_agile_services_grid_right">
						<h4>Reforestation certification</h4>
						<p>We certify to anyone who deserves it after reforestation.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
...
<!-- services-bottom -->
	<div class="services-bottom">
		<div class="container">
			...
			<p class="agile_para agileits_para">This is what we do now.</p>
			<div class="w3ls_news_grids">
				<div class="col-md-4 w3_agileits_services_bottom_grid">
					...
					<div class="agileinfo_services_bottom_grid2">
						<p>Is any material of natural or synthetic origin (other than liming materials) that is applied to soils.</p>
				...
				<div class="col-md-4 w3_agileits_services_bottom_grid">
					...
					<div class="agileinfo_services_bottom_grid2">
						<p>May refer to one or more of a wide variety of soil analyses conducted for one of several possible reasons.</p>
						<div class="agileits_w3layouts_learn_more hvr-radial-out">
							<a href="#" data-toggle="modal" data-target="#myModal">Read More</a>
						</div>
					</div>
				...
				<div class="col-md-4 w3_agileits_services_bottom_grid">
					...
					<div class="agileinfo_services_bottom_grid2">
						<p>Is the process of transplanting tree seedlings, generally for forestry, land reclamation, or landscaping purpose.</p>
						<div class="agileits_w3layouts_learn_more hvr-radial-out">
							<a href="#" data-toggle="modal" data-target="#myModal">Read More</a>
						</div>
					</div>
...
<!-- testimonials -->
	<div class="testimonials">
		<div class="container">
			<h3 class="agileits_w3layouts_head">This is <span>Testimonials</span> About Us</h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive">
			</div>
			<p class="agile_para">Below is a judgment of people against us.</p>
			<div class="w3ls_news_grids">
...
<!-- footer -->
	<div class="footer">
		...
		<div class="w3_agileits_footer_copy">
			<div class="container">
				<p>© 2018 Germinate. All rights reserved | Thanks to <a href="http://w3school.com">W3school.</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
